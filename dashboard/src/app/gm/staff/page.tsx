          ...
          {rows.length === 0 ? (
            ...
            <div key={s.id} style={{ display: "grid", gridTemplateColumns: "1.6fr 2fr 2fr 1.4fr", padding: "16px 24px", borderBottom: "1px solid #F4F4F1", fontSize: 14, alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {s.depts.map((d) => <span key={d} style={{ borderRadius: 999, padding: "3px 10px", fontSize: 12, fontWeight: 500, background: "#F1F6F2", color: "#0F5F4C", border: "1px solid #DCEBE1" }}>{deptLabel(d)}</span>)}
              </div>
