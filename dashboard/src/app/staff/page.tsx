...
export default function StaffDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", minHeight: "100vh", width: "100%", background: "#F4F1EA" }}>
      ...
      {/* SIDEBAR */}
      <aside style={ isMobile ? { position: "fixed", top: 0, left: 0, bottom: 0, width: 280, maxWidth: "82vw", zIndex: 90, background: "#FEFDFB", borderRight: "1px solid #E9E4D8", display: "flex", flexDirection: "column", overflowY: "auto", overflowX: "hidden", transform: drawerOpen ? "translateX(0)" : "translateX(-100%)", visibility: drawerOpen ? "visible" : "hidden", transition: "transform .26s cubic-bezier(.4,0,.2,1), visibility .26s", boxShadow: drawerOpen ? "0 0 40px rgba(0,0,0,.25)" : "none" } : { width: sidebarCollapsed ? 78 : 268, flexShrink: 0, background: "#FEFDFB", borderRight: "1px solid #E9E4D8", display: "flex", flexDirection: "column", position: "sticky", top: 0, alignSelf: "flex-start", height: "100vh", overflowY: "auto", overflowX: "hidden", transition: "width .22s cubic-bezier(.4,0,.2,1)" } }>
