...
export type DialOption = { c: string; d: string; name: string };

export default function CountryPicker({ options, value, onChange }: { options: DialOption[]; value: string; onChange: (dial: string) => void }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative", marginTop: 6, flexShrink: 0, width: 132 }}>
